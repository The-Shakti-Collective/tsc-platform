...
async function mirrorLeadFromMongo(mongoDoc) {
  ...
  const metadata = {
    ...
    rowId: mongoDoc.rowId,
    nameKey: mongoDoc.nameKey,
    personId: mongoDoc.personId?.toString?.() || mongoDoc.personId,
    assignedRepId: mongoDoc.assignedRepId?.toString?.() || mongoDoc.assignedRepId,
    createdBy: mongoDoc.createdBy?.toString?.() || mongoDoc.createdBy,
    importId: mongoDoc.importId?.toString?.() || mongoDoc.importId,
    artistProject: mongoDoc.artistProject,
    contactCategory: mongoDoc.contactCategory,
    webinarDates: mongoDoc.webinarDates,
    attended: mongoDoc.attended,
    attendanceDurationMin: mongoDoc.attendanceDurationMin,
    qnaAnswered: mongoDoc.qnaAnswered,
    artistType: mongoDoc.artistType,
    fullTimeWillingness: mongoDoc.fullTimeWillingness,
    primaryRole: mongoDoc.primaryRole,
    learningGoal: mongoDoc.learningGoal,
    learnedMusic: mongoDoc.learnedMusic,
    currentJourney: mongoDoc.currentJourney,
    planOption: mongoDoc.planOption,
    nextFollowupDate: mongoDoc.nextFollowupDate,
    nextFollowupTime: mongoDoc.nextFollowupTime,
    setReminder: mongoDoc.setReminder,
    tags: mongoDoc.tags,
    unsubscribeReason: mongoDoc.unsubscribeReason,
    status: mongoDoc.status,
    location: mongoDoc.location,
    reminderSent: mongoDoc.reminderSent,
    notifiedOverdue: mongoDoc.notifiedOverdue,
    remarks: mongoDoc.remarks,
    exlyOfferingId: mongoDoc.exlyOfferingId,
    exlyOfferingTitle: mongoDoc.exlyOfferingTitle,
    exlyOfferings: mongoDoc.exlyOfferings,
    customerIdExly: mongoDoc.customerIdExly,
    transactionIdExly: mongoDoc.transactionIdExly,
    lock: {
      lockedBy: mongoDoc.lockedBy,
      lockedAt: mongoDoc.lockedAt,
    },
  };
