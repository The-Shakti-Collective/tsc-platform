/** Client ESM mirror of shared/systemLogContract.js — keep in sync */
...
export const MODULE_VALUES = Object.values(MODULE);
...
export function inferModuleFromRoute(url = '') {
...
export function normalizeSeverity(value, fallback = SEVERITY.INFO) {
...
export function makeToastId(module, message, severity) {
...
export function normalizeSystemEventEntry(entry = {}) {
